...
const API_URL = "http://10.88.199.137:3000/api/posts?categorie_id=1";
                            ...
                            {posts.map((post, index) => (
                                <View style={styles.post} key={post.id}>
                                    ...
                                    <View style={styles.postContent}>
                                        <Image source={{ uri: `http://10.88.199.137:3000/uploads/${post.photo}.jpg` }} style={{ width: "100%", height: 400, marginTop: 10 }} />
                                    </View>
